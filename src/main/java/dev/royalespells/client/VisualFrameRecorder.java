 ...
 */
final class VisualFrameRecorder {
    private static final ExecutorService IO=Executors.newSingleThreadExecutor(r->{var t=new Thread(r,"Royale visual recording writer");t.setDaemon(true);return t;});
    ...
    static void render(RenderFrameEvent.Post event){
        ...
        }catch(Throwable e){e.printStackTrace();System.err.println("ROYALE_VISUAL_QA_FAILURE video export");Minecraft.getInstance().stop();}
    }
}
